...
public class Encriptar {
	...
	public String getContrasenya(String contrasenya){
		...
		try{
			...
			byte[] textoByte = contrasenya.getBytes("utf-8"); // ARRAY PARA LLAMAR A LA CLASE DE USUARIO Y PASARLA A BYTES CON LA COD UTF-8
			contrasenya=null;
